...
def nba_stats():
    ...
    for game in headers:
        ...
        away_leader_stat = str(game["gameLeaders"]["awayLeaders"]["points"]) + ' PTS' + ' | ' + str(game["gameLeaders"]["awayLeaders"]["rebounds"]) + ' REB' + ' | ' + str(game["gameLeaders"]["awayLeaders"]["assists"]) + ' AST'
